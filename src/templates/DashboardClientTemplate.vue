...
import ClientDepot from '@/components/ClientDepot.vue'
import ClientCommade from '@/components/ClientCommade.vue'
import CleintPrestation from '@/components/CleintPrestation.vue'
import ClientTransaction from '@/components/ClientTransaction.vue'
import ClientPrestationsStatus from '@/components/ClientPrestationsStatus.vue'
