...
import GestionCategoriePrestation from '@/components/GestionCategoriePrestation.vue'
import ValidationPrestataire from '@/components/ValidationPrestataire.vue'
import ListeCommandes from '@/components/ListeCommandes.vue'
