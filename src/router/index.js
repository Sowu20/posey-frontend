...
import RecherchePrestatairePage from '@/pages/RecherchePrestatairePage.vue'
import SingleUserPage from '@/pages/SingleUserPage.vue'
import DashboardClientPage from '@/pages/DashboardClientPage.vue'
import ShowProviderPage from '@/pages/ShowProviderPage.vue'
import DepotPage from '@/pages/DepotPage.vue'
import OrderPage from '@/pages/OrderPage.vue'
import ListOrdersPage from '@/pages/ListOrdersPage.vue'
import DashboardProviderPage from '@/pages/DashboardProviderPage.vue'
